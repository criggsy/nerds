...
class StickerPackItem extends StatelessWidget {
  ...
  Widget addStickerPackButton(
      bool isInstalled, WhatsappStickersHandler whatsappStickersHandler) {
      ...
      onPressed: () async {
        ...
        for (var e in stickerPack.stickers!) {
          stickers[WhatsappStickerImageHandler.fromAsset(
                  "sticker-packs/${stickerPack.identifier}/${e.imageFile as String}")
      ...
      child: SizedBox(
        child: ListTile(
          ...
          trailing: FutureBuilder(
              future: whatsappStickersHandler  
